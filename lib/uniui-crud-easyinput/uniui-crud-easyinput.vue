<template>
  <view class="uniui-crud-easyinput" :class="{ 'uniui-crud-easyinput-error': msg }" :style="boxStyle">
    <view class="uniui-crud-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
      <uni-icons v-if="prefixIcon" class="content-clear-icon" :type="prefixIcon" color="#c0c4cc" @click="onClickIcon('prefix')" size="22"></uni-icons>
      <textarea
        v-if="type === 'textarea'"
        class="uniui-crud-easyinput__content-textarea"
        ...
        :disabled="disabled"
        placeholder-class="uniui-crud-easyinput__placeholder-class"
      ...
      <input
        ...
        class="uniui-crud-easyinput__content-input"
        :style="inputStyle"
        :name="name"
        :value="val"
 ...
 * @example <uniui-crud-easyinput v-model="mobile"></uniui-crud-easyinput>
 */
...
export default {
  ...
  watch: {
    ...
    modelValue: {
      handler(newVal) {
        this.val = newVal
        this.localPlaceholder = newVal !== undefined && newVal !== null && newVal !== '' ? '' : this.placeholder
      },
      immediate: true,
      deep: true
    },
